...
model_config = {"BATCH_SIZE": 64, "MAX_LEN": 128, "learning_rate": 1e-4, "eps": 1e-8, "RANDOM_SEED": 666,
                "warmup_steps": 100, "EPOCHS": 3, "shuffle": True, "masking": False, 
...
for t in range(1):
    ...
    for agent in range(6):
        ...
        output_dir = "init_model/" + "_".join(["agent", str(agent), "round", str(t)])
        base_model_name = "model_base/quatrain/" + masking_str + "1680_" + masking_str + "_epoch0"
